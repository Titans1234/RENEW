 ...
 * 
 * import com.lti.entity.Admin; import com.lti.pojo.AdminLogin; import
 * com.lti.pojo.RemoveFlight; import com.lti.repo.AdminRepo; import
 * com.lti.rest.AdminRestController;
 * 
 ...
 * class TestAdmin {
 * 
 * @Autowired private AdminRestController repo;
 * 
 * @Test public void testSave() { Admin a = new Admin();
 * a.setUserName("ranbir"); a.setPassword("mumbai"); repo.save(a); }
 * 
 * @Test public void testRemove() { RemoveFlight r=new RemoveFlight();
 * r.setFlightId(131103); repo.removeFlight(r); }
 * 
 * 
 ...
 * 
 * @Test void delAdmin() { // repo.delete() } }
 */